...
export default function Debite() {
...
//           <p style="font-weight: bold;">نام شرکت: ${settings[0]?.company_name || "-"}</p>
//           <p style="font-weight: bold;">آدرس: ${settings[0]?.address || "-"}</p>
//           <p style="font-weight: bold;">تلفن: ${settings[0]?.phone || "-"}</p>
//         </div>
//         <div style="margin-top: 10px;">
//           <p style="font-weight: bold;">ایمیل: ${settings[0]?.email || "-"}</p>
//           <p style="font-weight: bold;">توضیحات: ${settings[0]?.description || "-"}</p>
//         </div>
...
//               <th style="border: 1px solid #ddd; padding: 10px;">شماره</th>
//               <th style="border: 1px solid #ddd; padding: 10px;">نام مشتری</th>
//               <th style="border: 1px solid #ddd; padding: 10px;">ارز</th>
//               <th style="border: 1px solid #ddd; padding: 10px;">مقدار</th>
//               <th style="border: 1px solid #ddd; padding: 10px;">تاریخ ایجاد</th>
//               <th style="border: 1px solid #ddd; padding: 10px;">اضافه شده توسط</th>
//             </tr>
//           </thead>
//           <tbody>
//             ${
...
//                     <td style="border: 1px solid #ddd; padding: 10px;">${row.account_name}</td>
//                     <td style="border: 1px solid #ddd; padding: 10px;">${row.moneyType}</td>
//                     <td style="border: 1px solid #ddd; padding: 10px;">${formatNumber(row.belance)}</td>
//                     <td style="border: 1px solid #ddd; padding: 10px;">${date(row.date_created)}</td>
//                     <td style="border: 1px solid #ddd; padding: 10px;">${row.user_name}</td>
//                   </tr>
//                 `;
//               }).join("")
//             }
...
//       html2canvas: {
//         scale: 2,
//         useCORS: settings[0]?.company_pic?.includes("http"), // فعال‌سازی CORS فقط در صورت نیاز
//         logging: false,
//         onclone: (clonedDoc) => {
...
//   };
  ...
  return (
    <div className="w-100 h-100">
      ...
      >
        <h2 className="m-2 fw-bold mb-4"><FormattedMessage id="debit.report"/>
        </h2>
